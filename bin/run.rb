...
opening_menu = PROMPT.select("Please select from the options below:", ["1. Explore the parks", "2. View tags", "3. Find or create tags", "4. Delete tags"])
...
puts Tag.find_by(name: user_selection_tags)

user_find_or_create_tags = PROMPT.select("View and/or create tags")
